...
## 📖 Documentation
For a full guide on how to write scripts and use commands, see the [User Guide](https://github.com/firesmasher-c6/Coder/blob/main/guide.md).
For the **official** CodeHub click [this](https://firesmasher-c6.github.io/CodeHub/)
